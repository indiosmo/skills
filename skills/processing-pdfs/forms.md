**These steps must be completed in order because each step's output feeds into the next -- skipping ahead produces incorrect coordinates and misaligned text.**
